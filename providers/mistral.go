...
// request the trailing usage chunk; it is off by default because compat gateways in front of
// Mistral may reject stream_options.
...
// Mistral's OpenAI-shaped stream.
func (p *MistralProvider) ParseStreamResponseRich(chunk []byte) (types.StreamChunk, error) {
