...
// ParseResponseWithUsage extracts both the generated text and response details from the vLLM API response.
func (p *VLLMProvider) ParseResponseWithUsage(body []byte) (string, *types.ResponseDetails, error) {
	var response struct {
		ID      string `json:"id"`
